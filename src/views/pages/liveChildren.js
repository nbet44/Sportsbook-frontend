...
import { LiveBasketBall, LiveFootball, LiveTableTennis } from './baseSport'
                ...
                <React.Fragment>
                    ...
                    < TabContent className={`category-content ${clientPlatform === "desktop" ? "mr-5" : "mr-1"}`} activeTab={active} style={{ width: "70%" }}>
                        <TabPane tabId='1'>
                            {
                                active === "1" ? (
                                    <LiveFootball {...{ leagueData, eventData, handleRefresh, isRefreshing, timerNumber, oddType }} />
                                ) : ""
                            }
                        </TabPane >
                        <TabPane tabId='2'>
                            {
                                active === "2" ? (
                                    <LiveTableTennis {...{ leagueData, eventData, handleRefresh, isRefreshing, timerNumber, oddType }} />
                                ) : ""
                            }
                        </TabPane>
                        <TabPane tabId='3'>
                            {
                                active === "3" ? (
                                    <LiveBasketBall {...{ leagueData, eventData, handleRefresh, isRefreshing, timerNumber, oddType }} />
                                ) : ""
                            }
                        </TabPane>
                        <TabPane tabId='4'>
