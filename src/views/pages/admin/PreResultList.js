    ...
    <div>
      ...
      <div className="content-body">
        <Card className="b-team__list">
          <CardHeader >
            <div className="left">
              <h2 className="b-list m-auto px-5 py-1 transaction-title">{getTextByLanguage("Pre Result")}</h2>
            </div>
          </CardHeader>
                  ...
                  return (
                    <React.Fragment key={index}>
                      <div className="row col-12 py-1" style={{ borderBottom: "1px solid #82868b" }}>
                        ...
                        <span className="col-3"><a style={{ color: "white" }} href={`/admin/pre-result/sport/${item.SportId}`}>{item.SportName}</a></span>
                      </div>
                    </React.Fragment>
                  )
                }
...
export default PreResultListCmp
