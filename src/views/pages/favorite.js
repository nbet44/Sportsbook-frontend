...
const FavoriteCmp = () => {
    ...
    return (
        <div>
            ...
            <HeaderCmp />
            <div className="content-body mx-0 d-flex justify-content-between">
                <div style={{ width: "70%" }}>
                    ...
                    <TabContent className={`category-content ${clientPlatform === "desktop" ? "mr-5" : "mr-1"}`} activeTab={active} style={{ width: "100%" }}>
                        <TabPane tabId='1'>
                                                                        ...
                                                                        <table className="table-style table table-bordered">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td className="match-event match-team">{getTextByLanguage(item.HomeTeam)}</td>
                                                                                ...
                                                                                <tr>
                                                                                    <td className="match-event match-team">{getTextByLanguage(item.AwayTeam)}</td>
